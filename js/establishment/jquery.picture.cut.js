    ...
    var methods = {
        ...
        init: function(Options) {
            var OptionsIfEmpty = {
				...
				ActionToSubmitImage: "src/php/image.php",
            ...
            var defaults = {
                ...
                ActionToSubmitCrop: "",
				ActionToSubmitImage: "../image_upload/src/php/image.php",
                FolderOnServer: "",
                ThumbFolderOnServer: "",
                DataPost: {},
                DefaultImageButton: "",
            ...
            return this.each(function() {
                    ...
                    var JpaneDialogCallBack = function() {
                        ...
                        $("#JtuyoshiCrop #button_crop_recortar").bind("click", function() {
                            ...
                            $.post(url, data, function(data) {
                                ...
                                //Redimencionar_Janela()
								window.location = 'http://sportshub365.com/establishment/profile_image';
								//url1 = Options.ActionToSubmitImage;
								//alert(url1);
								//data = 1;
								/*$.post(url1, data, function(response) { 
									$('#profile_img').html(response)
								    $('input').customInput();
                ...
                var Setando_AjaxUpload = function(element) {
                    ...
                    element.uploadAjax({
                        ...
                        extError: function() {
                            PcAlert("types2 are supported: " + (Options.Extensions.join(",")).toString(), "Attention")
                        }
                    });
