...
function ShowSportFixturePDF(path)
{
 var total_sports=$("#total_sports").val();
//$('.preloader').show();
 var checked_sports=Array();
 ...
 //alert(date_from);
 SearchResultPDF(path,'','',date_from,date_end,search_text,checked_sports_string)
}
...
function SearchResultPDF(PATH,cp,ppr,date_from,date_end,search_text,sport_id){   

var url=PATH+"downloadpdf?cp="+cp+"&ppr="+ppr+"&date_from="+date_from+"&date_end="+date_end+"&search_text="+search_text+"&sport_id="+sport_id;
