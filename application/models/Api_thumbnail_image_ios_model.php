...
class Api_thumbnail_image_ios_model {
...
if ($this->mime == 'image/jpeg' or $this->mime == 'image/pjpeg') imagejpeg($NewImg,$path_img,100);
elseif ($this->mime == 'image/gif') imagegif($NewImg,$path_img,100);
elseif ($this->mime == 'image/png') imagepng($NewImg,$path_img,100);
else return(false);
return(true);
}
