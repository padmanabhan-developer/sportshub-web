...
class Sport_enginetest extends MY_Controller {
        ...
        public function index()
        {
			   ...
			   //$this->xmlrpc->server('http://localhost:81/liveonsat/sh365/welcome', 81);
                ...
                {
               echo $comment = "Error: ".$this->xmlrpc->display_error();
                 $this->xmlrpc->display_response();
                // $this->Client_model->SetSyncDate($datestr,$comment);
                }
                else
                {
