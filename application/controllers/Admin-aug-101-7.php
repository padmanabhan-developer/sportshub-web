...
public function value_required($value,$field)
	...
	public function channels()
	{
		...
		$this->data['total_records'] = $this->Admin_model->ChannelListCount($this->data['search_text']);
		...
		$this->data['channel_list'] = $this->Admin_model->ChannelList($this->data['search_text'],"limit ".$this->data['pagination']['start_limit'].",".$this->data['pagination']['end_limit']);
	...
	public function providers()
	{
		...
		$this->data['total_records'] = $this->Admin_model->ProviderListCount($this->data['search_text']);
		...
		$this->data['provider_list'] = $this->Admin_model->ProviderList($this->data['search_text'],"limit ".$this->data['pagination']['start_limit'].",".$this->data['pagination']['end_limit']);
	...
	public function provider_edit() {
	  ...
	  if($this->session->userdata('admin_email')) {
	   ...
	   $this->data['provider_id'] = $provider_id;
			if ( $provider_id ) 
   			{ 
		$this->data['total_records'] = $this->Admin_model->ChannelProviderListCount($this->data['search_text'],$provider_id);
		$this->data['ppr']=20;
		$cp=1;
    	if(empty($this->data['cp'])){$this->data['cp']=$cp;}else{$this->data['cp']=1;}
    	$this->data['pagination'] = $this->Pagenation($this->data['cp'], $this->data['ppr'],$this->data['total_records']);
		...
		$this->data['channel_list']=$this->Admin_model->ChannelProviderList($this->data['search_text'],$provider_id,"limit ".$this->data['pagination']['start_limit'].",".$this->data['pagination']['end_limit']);
