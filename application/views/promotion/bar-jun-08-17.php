          	   ...
          	   <div class="container">
               		<div class="address1">
						...
						<?php if(isset($profiledetails['geo_lat']) && isset($profiledetails['geo_lang'])){ ?>
                         <a href="http://maps.google.com/?q=<?php echo $profiledetails['geo_lat'];?>,<?php echo $profiledetails['geo_lang'];?>" target="_blank"><span class="yellow1">GET DIRECTIONS</span></a><span class="spanmore3">></span>
                         <?php } ?>
                    </div>
        ...
        <div class="section8 sec_hours">
            <div class="container">
                ...
                <div class="address2">
				  ...
				  ?>
                  <?php if($happyhourscount ==1){?><h4>Happy hours</h4> <?php } ?>
        ...
        <div class="section9">
            ...
            <?php //print_r($offers);?>
                <div class="address1">
                   ...
                   Promocode(<?php echo $offer['promo_code']?>)
                    <?php }?></p>
                    <?php } ?>
                </div>
                <div class="address2">
                    ...
                    <p>- The <?php echo $event['date']?>, <?php echo date('H:i', strtotime($event['time']))?> - <?php echo $date = date('H:i', strtotime($event['time'])+(3600*$event['duration'])); ?></p>
                    <?php } ?>
                </div>
