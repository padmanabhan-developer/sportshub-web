...
<div id="wrapper">
     ...
     <div class="logo_home"><a href="<?php echo base_url();?>"><img src="images/logo2.png" alt="" /></a></div>
     ...
     <div id="banner4">
     	  <div class="layer">
          	   <div class="container">
                    <div class="home_left">
                    	 <h4>VENUE</h4>
                         <h1>GET MORE CUSTOMERS <br />IN YOUR VENUE</h1>
                         <a href="<?php echo base_url();?>venue" class="button">GO TO VENUES</a>
                    </div><!--close home_left--> 
                    
                    <div class="home_left home_right">
                    	 <h4>Sports Fans</h4>
                         <h1>WATCH LIVE SPORT <br />NEAR YOU</h1>
                         <a href="<?php echo base_url();?>sportsfans" class="button">GO TO Sports Fans</a>
                    </div><!--close home_left--> 
               </div>
          </div>
