     	  ...
     	  <div class="sectionmain">
                    ...
                    <form name="filter_bars" id="filter_bar" method="get" >
                        ...
                        <div class="col-sm-12 ">
                            <div class="locationinput">
                                <div class="inputnew">
                                <input class="basic-slide" id="setlocation" id="name" type="text" value="<?php echo $filteraddress?>" placeholder="Type your location... " />
                                <label for="name" ><i class="fa fa-map-marker" aria-hidden="true"></i><span class="loc"></span>  Venues near you</label>
				...
				?>  
                        <div class="barlist col-xs-12 col-sm-4">
                            <div class="carbox">
                            	<a class="img-carbox" style="background:url(<?php echo base_url();?>images/bar-img-1.jpg);" href="<?php echo base_url();?>promotion/bar/<?php echo $profile['id']?>">
                                    <div class="overlay">
