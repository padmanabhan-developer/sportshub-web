               ...
               <div class="menu">
                    <div class="nav-1 nav-collapse">
                      <ul id="main-menu" class="sm sm-blue">
                        ...
                        <li><a href="<?php echo base_url();?>app" class="highlighted" >Personal planner</a></li>
     ...
     <div id="banner3">
     	  <div class="layer">
          	   <div class="container">
                         ...
                         <p>What's on tonight? With Sportshub365 <br />

Personal Planner you can make your own <br />

TV schedule and share it with your friends.</p>
                         <div class="box_center">
                              <a href="<?php echo base_url();?>app/signup" class="button">SIGN UP NOW FOR FREE</a>
                    	 </div>
                         <p style="padding:10px 0;"> (or) </p>
                          <div class="box_center">
                              <a href="<?php echo base_url();?>app/login" class="button">LOGIN</a>
                    	 </div>
     ...
     <div id="content">
     	  <div class="section1">
          	   <div class="container">
               		<div class="row">
                        ...
                        <div class="feature_image feature_image3"><img src="images/img3.png" /></div>
                    </div>
               </div><!--close container-->
          </div><!--close section1-->
          ...
          <div class="section7 section8">
          	   <div class="container">
               		<h2 class="plannerh2">try it now- <span class="yellow">works on both COMPUTERS & MOBILE DEVICES</span> </h2>
                    <div class="box_center">

                    	 <a href="<?php echo base_url();?>app/signup" class="button">TRY PERSONAL PLANNER</a>
