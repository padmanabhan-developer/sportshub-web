...
<div id="wrapper">
        ...
        <div class="menu">
          <div class="nav-1 nav-collapse">
            <ul id="main-menu" class="sm sm-blue">
              ...
              <li><a href="<?php echo base_url();?>recommendbar" class="highlighted">Recommend a Bar</a></li>
  ...
  <div id="banner3">
    ...
    <div class="banner_bottom">
      <div class="container"> <span class="prev"><a href="<?php echo base_url();?>venue">VENUES</a></span> <span class="next"><a href="<?php echo base_url();?>sportsfans">Sports Fans</a></span> </div>
    </div>
    <!--close banner_bottom--> 
  </div>
  <!--close banner-->
...
-->          <div class="feature_image feature_image3 recommend_bar">
    ...
    <!--close section7-->
    <div class="section5">
      <div class="container"> <span class="prev2"><a href="<?php echo base_url();?>venue">VENUES</a></span> <span class="next2"><a href="<?php echo base_url();?>sportsfans">Sports Fans</a></span> </div>
    </div>
    <!--close section5--> 
  </div>
  <!--close content-->
