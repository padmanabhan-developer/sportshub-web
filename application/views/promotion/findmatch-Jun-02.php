        ...
        <div class="col-12">
            <div class="container">
                ...
                <form name="findmatchfloat" id="findmatchfloat" method="get">
                    <input class="header_search" id="header_search" placeholder="Search for team or sports...  " type="text" value="<?php echo $findval?>">
                        ...
                        <div class="locationinput">
                                <div class="inputnew"> 
                                	<form name="findmatch" id="findmatch" method="get">
                                		<input class="banner_search"  id="banner_search" placeholder="Search for team or sports...  " type="text" value="<?php echo $findval?>"><label for="name"  id="formsubmit"><i class="fa fa-map-marker" aria-hidden="true"></i>SEARCH</label> 
