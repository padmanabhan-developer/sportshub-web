        ...
        <div class="col-12">
            <div class="container">
                ...
                <form name="findmatchfloat" id="findmatchfloat" method="get">
                    <input class="header_search21" id="header_search" placeholder="Search for teams, leagues or sports...  " type="text" value="<?php echo $findval?>">
    ...
    <div id="banner61">
                        ...
                        <div class="locationinput">
                                <div class="inputnew"> 
                                	<form name="findmatch" id="findmatch" method="get">
                                		<input class="banner_search"  id="banner_search" placeholder="Search for teams, leagues or sports...  " type="text" value="<?php echo $findval?>"><label for="name"  id="formsubmit"><!--<i class="fa fa-map-marker" aria-hidden="true"></i>-->SEARCH</label> 
     ...
     <div class="section7">
            <div class="container" id="barmatches">
            	<h2 class="title_text">
                <?php if($findval!=''){
						echo 'Search results for "'.$findval.'"';}
					  else{
		...
		$(function() {
			...
			$("#header_search").catcomplete({
				...
				focus: function(event, ui) {
					...
					// manually update the textbox and hidden field
					$(this).val(ui.item.label);
					$("#findvalheader").val(ui.item.label);
