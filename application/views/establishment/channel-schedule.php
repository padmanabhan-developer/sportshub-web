...
<div class="schedule-right">
  ...
  <div class="event-form"> <span class="event-form-box">
    ...
    </span> <span class="event-form-box">
  ...
  <!-- close event_row --> 
  <?php echo form_close();?>
  <div id="show_channel" class="tool-addressdown">
    <?php $this->load->view('establishment/display-schedule');?>
  </div>
  <!-- close show_channel div -->
  <?php } else { ?>
  <div class="no_content"> <span class="no_content_title1">no content</span> <span class="no_content_title2">Please select your tv provider &amp; channels before making your tv schedule</span> <a class="blue_button button_center" href="<?php echo base_url();?>establishment/tv_provider_channel">CHOOSE TV PROVIDER</a> </div>
  <?php } ?>

</div>
<!-- close schedule-right --> 
       <div style="width:100%;">&nbsp;</div>
       <div class="pagination_ad">
            <center>
            <!-- /32361281/DFP_BEHRENTZ_SPORTSHUB_728X90_2 -->
            <div id='div-gpt-ad-1505826037322-6' style='height:90px; width:728px;'>
            <script>
            googletag.cmd.push(function() { googletag.display('div-gpt-ad-1505826037322-6'); });
            </script>
            </div>
            </center>
        </div>
