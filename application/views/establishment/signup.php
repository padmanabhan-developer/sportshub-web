...
<html lang="en">
  ...
  <div class="wrapper">
      ...
      <h2>Sign up here</h2>
      <span class="mailspn">
      	<span class="form_box"><?php echo form_input($attribute['title']);?></span>
      	<?php echo form_error('title', '<div class="error">', '</div>'); ?>
      </span> 
      <span class="mailspn">
      	<span class="form_box"><?php echo form_input($attribute['email']);?></span>
      	<?php echo form_error('email', '<div class="error">', '</div>').'<div class="error">'. $msg.'</div>'; ?>
      </span>      
      <span class="passspn">
      ...
      <span class="mailspn">
      	<span class="form_box"><?php echo form_input($attribute['resellercode']);?></span>
      	<?php echo form_error('resellercode', '<div class="error">', '</div>').'<div class="error">'. $codemsg.'</div>'; ?>
      </span>
...
<?php echo form_close();?>
       <!-- add section start-->
         <div class="add_3"><script type="text/javascript" src="http://sportshub365.com/spotway/adb.php?tag=322570660558594a155&width=728&height=90"></script> </div>
       <!-- add section end-->
  </div><!--close wrapper-->
