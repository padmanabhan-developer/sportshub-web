 <div class="popup-box" >
                   ...
                   <h2>add new offer</h2> <div id="errorDiv1" style="float:left; width:268px; background:#f4f3f3; color:#e60000; border:dotted 1px #c12e1e; font-family: 'open_sansregular'; margin-top:2px; margin-bottom:8px; padding:5px;font-size:13px; display:none;">       </div>
                    <?php  
					//echo "action-".$form_action."".$offer_id;
					if($form_action=="insert"){ echo form_open(base_url()."establishment/display_offer",$attribute_offer['form']);}
                    else {
                      echo form_open(base_url()."establishment/display_offer",$attribute_offer['form']);
