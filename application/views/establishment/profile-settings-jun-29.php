...
<html lang="en">
  ...
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: "ca-pub-8922815310488274",
...
#tool-addresstop .tooltip.bottom {
  ...
  <div class="wrapper">
    ...
    <div id="content">
    	 <div class="col-md-10 inside-content">
      ...
      ?>
                      <div  id="tool-addresstop" class="col-lg-6 col-md-6 col-sm-6 box-upload">
                         ...
                         <?php if($step_2 == 2){ ?>  <img class="" src="<?php echo base_url();?>img/dashboard/icon.png" id="step_2_tooltips_hover" data-toggle="tooltip" data-placement="bottom" data-original-title="Click Here to Enter the Image Gallery and Upload Images of your bar." style="width: 20px;"> <?php } ?>
...
<?php } 
    ?>
               ...
               <input class="input" type="text" placeholder="WEBSITE" value="<?php echo $website;?>" name="website" id="us2-website" ></span>
						...
						<?php if($step_1 == 2){ ?><img class="" src="<?php echo base_url();?>img/dashboard/icon.png" id="step_1_tooltips_hover" data-toggle="tooltip" data-placement="left" title="Add Name, Address, Short description, Phone, Email and Website of your Bar, please make sure to save." style="width: 20px;"> <?php } ?></span>
                       <?php echo form_close();?> 
