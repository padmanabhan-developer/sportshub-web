 <div class="schedule-left">
                      <h2 class="title2">Channels:</h2>
                        ...
                        <input id="channel_search_text" class="search-input" type="text"  value="<?php echo $channel_search_text;?>" placeholder="Search" name="channel_search_text">
                        <input class="search-button" type="button" name="chl_submit" onclick="SearchChannel(path.value,channel_search_text.value)">
 ...
 <?php echo form_close();?>
				...
				<?php } else { ?>
                	<div class="no_content">
                            ...
                            <a class="blue_button button_center" href="<?php echo base_url();?>establishment/tv_provider_channel">CHOOSE TV PROVIDER</a>
</div>
<?php } ?>
