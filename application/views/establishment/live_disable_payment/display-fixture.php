...
<?php //echo $subscription."--".$free_status;?>
        ...
        if($subscription == 0 && $free_status==0){
            if(strtotime($fixture['gmt_date_time']) != strtotime(date('d-m-Y'))) continue;
			  ...
			  ?>
                ...
                <?php //echo strtotime($fixture['gmt_date_time'])."-".strtotime(date('d-m-Y'));?>
