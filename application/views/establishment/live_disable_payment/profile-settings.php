                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 rightbar">
                        	 <div class="box">
                                  ...
                                  <div id="payment-modal" class="box-inner">
                                        ...
                                        <!--
                                        <a href="javascript:void(0);" data-cta-target=".js-dialog" data-freedays="<?php echo $free_days_left;?>" class="yellow-button align-center" >Upgrade now</a> -->
                                        <a href="javascript:void(0);" class="yellow-button align-center" >Upgrade now</a>
                                        <?php }
                                        else{
                                          ?>
