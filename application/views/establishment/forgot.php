...
<div id="popup1" class="modal-box">
  ...
  <div class="wrapper">
       ...
       <div class="header2">
          <div class="container">
               <div class="logo2"><a href="<?php echo base_url();?>venue"><img src="<?php echo base_url();?>images/logo2.png"></a></div>
            </div>
       </div>
       ...
       <div class="signup_box">
          ...
          <?php
                   echo form_open(base_url()."establishment/forgot",$attribute['form']);
                   echo form_hidden('caller','Send');
                 ?>
            <span class="mailspn">     
            <span class="form_box"><?php echo form_input($attribute['email']);?></span>
               <?php if ($pos === false) {?>
               <?php echo form_error('email', '<div class="error">', '</div>').'<div class="error">'. $errormsg.'</div>';; ?> 
               <?php }?>
               </span>
               
            <?php echo form_input($attribute['submit']);?>
            <?php echo form_close();?>
			<h6>Already have account?  <a href="<?php echo base_url();?>establishment/login">login</a></h6>
