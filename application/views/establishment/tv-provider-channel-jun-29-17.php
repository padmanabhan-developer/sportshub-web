          ...
          <div class="step3tool_tip">
           ...
           <?php }?>
			...
			<div id="step2tooltip" class="tvprovider">
              	   <h2 class="title2">
                   <?php if($displaytooltip ==1){ ?>
                   <span id="step_1_tooltips" data-toggle="tooltip" data-placement="top" title="<span style='cursor: pointer;' class='hidetooltip pull-right'>x</span><b>STEP 1 </b> <br> <span style='text-transform: uppercase;'>Choose the TV Providers and the Channels, That are Available in your establishment.
