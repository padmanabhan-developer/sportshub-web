...
<html lang="en">
  ...
  <div class="wrapper barwrapper">
    ...
    <div id="content" class="barcontent">
       <div class="container">
             <?php if(($subscription==0) && ($free_status==0)){?>
              <a href="javascript:void(0);" class="add-new-event" data-cta-target=".js-dialog" >add offer</a>
              <div class="js-dialog  modal  dialog" style="text-align: center;">
                <span class="modal-close-btn"></span>
                <div id="open_event">
                  <?php $this->load->view('stripe/index_offer');?>
                </div>
              </div>
             <?php }
             else{?>
...
<?php if($maxcount <3){?>
            <a href="javascript:void(0)" class="add-new-event" data-cta-target=".js-dialog"  title="Click here to Add" >add offer</a>
              <div class="js-dialog  modal  dialog" style="text-align: center;">
      <span class="modal-close-btn"></span>
     <div id="open_offer">
    ...
    $form.find('.submit').val('Submit Payment');
      ...
      $.ajax({
        ...
        success: function(response){
          ...
          window.location.href="<?php echo base_url('establishment/events'); ?>";
        },
