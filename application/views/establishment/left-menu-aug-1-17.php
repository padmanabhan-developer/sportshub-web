 ...
 <?php $profilelevel = 1+$this->session->userdata('profile_step1')+ $this->session->userdata('profile_step2')+$this->session->userdata('profile_step3')+$this->session->userdata('profile_step4')+$this->session->userdata('profile_step5');
// echo $this->session->userdata('profile_step1')."--".$this->session->userdata('profile_step2')."--".$this->session->userdata('profile_step3')."--".$this->session->userdata('profile_step4')."--".$this->session->userdata('profile_step5');
//echo $this->session->userdata('schedule_step1')."--".$this->session->userdata('schedule_step2')."--".$this->session->userdata('schedule_step3');
  ...
  ?>
            ...
            <li class="treeview">
			 <center>
              <img src="<?php echo base_url();?>/Sample/images/ses.jpg">
			</center>
            </li> 
            </ul>
