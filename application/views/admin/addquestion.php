  ...
  <div class="wrapper">
    ...
    <div id="content">
       <div class="container">
        	...
        	<div class="row">
             <div class="box">
            <h2 class="title2">Add Question</h2>
        		<div class="col-lg-12 col-md-6 col-sm-6 box-form">
               
                <!--<div class="box">-->
                <?php 
                 	 echo form_open(base_url()."admin/addquestion/", $attribute_question['form']);
                ...
                <br>
                  ...
                  <span class="form-row">
                    <div class="col-lg-1 col-md-1 col-sm-1">
                    	<input type="radio" value="0" id="answer_label" data-id="0" name="correct_answer"><label for="answer_label" class=""></label>
                    </div>
                    <div class="col-lg-4">
                    <input type="txt" placeholder="Answer" class="input" id="answer0" value="" name="answer[]">
                    <label id="answer0" style="display:none; color:#F00;" >Please enter answer</label>
                    </div>
                    <div class="col-lg-1">
