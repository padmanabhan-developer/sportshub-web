  ...
  <div class="wrapper">
    ...
    <div id="content">
       <div class="container">
           ...
           <div class="red-box">
                      <h2>Welcome to Sportshub365 Admin</h2>
                   ...
                   <div class="row">
                      <div class="one_fifth">
                           ...
                           <h2><?php echo $dashboard[0]->totaluser; ?> Users</h2>
                             </a>
                        </div><!-- close one_fifth -->
                        ...
                        <div class="one_fifth">
                           ...
                           <h2><?php echo $dashboard[0]->totalestablishment; ?> Establishments</h2>
                             </a>
                        </div><!-- close one_fifth -->
                        ...
                        <div class="one_fifth">
                           ...
                           <h2><?php echo $dashboard[0]->totalmatches; ?> Matches</h2>
                             </a>
                        </div><!-- close one_fifth -->
                        <!--
                        <div class="one_fifth">
