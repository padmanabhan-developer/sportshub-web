...
<html lang="en">
  ...
  <div class="wrapper">
    ...
    <div id="content">
       <div class="container">
       		<a class="back-button" href="<?php echo base_url();?>admin/quiz_setting">Settings</a>
            <a href="<?php echo base_url();?>admin/addquestion" class="add-new-event" >Add Question</a> 
            <div class="events">
                   <h2 class="title2">Quiz - Questions</h2> </br>
                   ...
                   <div class="row3">
                 	...
                 	<?php $this->load->view('admin/quiz_display');?>
              </div><!-- close events -->
         </div><!-- close container -->
    </div><!-- close content -->
  </div><!--close wrapper-->
  ...
  // Run the script on DOM ready:
   $(document).ready(function() {
		default_question_load_function();
