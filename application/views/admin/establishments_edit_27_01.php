       ...
       <div class="container">
            <div class="profile-setting">
               <a href="<?php echo base_url();?>admin/establishments" class="back-button">BACK TO  LIST</a>
                 ...
                 <?php $email = (!empty($profile_detail['email'])) ? $profile_detail['email'] : ''; ?>  
                   <div class="row2"><h5><small>ACCOUNT E-MAIL: </small><?php echo $email; ?></h5></div>    
              <?php 
           ...
           Your premium account is going to expire. Renew now...
            ...
            ?>  <!-- close darkblue-box -->
               ...
               <div class="row">
                    <?php 
					  echo form_open_multipart(base_url()."admin/establishments_edit/$est_user_ref",$attribute_upload['form']);
             ...
             ?>
                         ...
                         <a class="yellow-button align-center" href="<?php echo base_url();?>admin/establishment_image/<?php echo  $est_user_ref ?>">Go to image gallery</a>
                         </div>
  ...
  <?php
    ...
    <script src="<?php echo base_url();?>js/locationpicker.jquery.js"></script>
               ...
               $maplang = (!empty($profilelang)) ? $profilelang : '-3.7492200000000366';
                                    echo form_open(base_url()."admin/establishments_edit/$est_user_ref",$attribute_profile['form']);
                ...
                onchanged: function (currentLocation, radius, isMarkerDropped) {
                 ...
                 // alert(addr[0]);alert(addr[1]);alert(addr[2]);
                  ...
                  $('#us2-address').val(newadd+baladd);
                   if(newadd =='fulladd') newadd = newadd;
                  $('#us2-address').val(newadd);
                           ...
                           <?php if(count($opening_hours)>0)
                           {
                            ?>
                              <div class="box">
                                ...
                                action="<?php echo base_url();?>admin/establishments_edit/<?php echo  $est_user_ref ?>"
                           ...
                           <div class="box">
                                <h2 class="title">Change password</h2>
                                  <div class="box-inner">
                                       ...
                                       <?php
                                    echo form_open(base_url()."admin/establishments_edit/$est_user_ref ",$attribute['form']);
      ...
      <div class="popup-box">
                   ...
                   <?php
                      echo form_open(base_url()."admin/establishments_edit/$est_user_ref",$attribute_update_card['form']);
                                ...
                                <h2 class="title">Choose facilities here</h2>
                                  <div class="box-inner">
                                    ...
                                    <form id="facility_frm" accept-charset="utf-8"
                                     method="post" name="facility_frm" action="<?php echo base_url();?>admin/establishments_edit/<?php echo  $est_user_ref ?>">
