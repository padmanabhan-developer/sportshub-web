  ...
  <div class="wrapper">
    ...
    <div id="content">
       <div class="container">
              ...
              <a href="javascript:void(0)" class="add-new-event" data-cta-target=".js-dialog1" id="popup2" title="Click here to Add" onclick="javascript:NewProviderForm('<?php echo base_url();?>admin/');">New Provider</a>
