 <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="<?php echo base_url();?>admin/admin_user">
                <i class="menu-icon7"></i> <span>Admin Users</span> 
              </a>
            </li>
            <li class="treeview">
              <a href="<?php echo base_url();?>admin/matches">
                <i class="menu-icon15"></i> <span>Matches</span> 
              </a>
            </li>
            <li class="treeview">
            ...
            <li class="treeview">
              <a href="<?php echo base_url();?>admin/channels">
                <i class="menu-icon3"></i> <span>Channels</span> 
              </a>
            </li>
            <li class="treeview">
              <a href="<?php echo base_url();?>admin/providers">
                <i class="menu-icon3"></i> <span>Providers</span> 
              </a>
            </li>
            <li class="treeview">
            ...
            <li class="treeview">
              <a href="<?php echo base_url();?>admin/rating_comment">
                <i class="menu-icon14"></i> <span>Rating / Comments</span> 
              </a>
            </li>
            <li class="treeview">
            ...
            <li class="treeview">
              <a href="<?php echo base_url();?>admin/reseller">
                <i class="menu-icon12"></i> <span>Reseller</span> 
              </a>
            </li>
             <li class="treeview">
              <a href="<?php echo base_url();?>admin/paymenthistory">
                <i class="menu-icon13"></i> <span>Payment</span> 
              </a>
            </li>
              <!--<li class="treeview">
            ...
            <li class="treeview">
              <a href="https://analytics.google.com/analytics/web/?et&authuser=0#report/visitors-overview/a70118948w107294902p111758123/" target="_blank">
                <i class="menu-icon11"></i> <span>Analytics</span> 
              </a>
            </li>  
            <li class="treeview">
            ...
            <li class="treeview">
              <a href="<?php echo base_url();?>admin/recommendabar">
                <i class="menu-icon3"></i> <span>Recommend a bar</span> 
              </a>
            </li>
            <li class="treeview">
