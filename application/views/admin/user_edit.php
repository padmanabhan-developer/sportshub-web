  ...
  <div class="wrapper">
    ...
    <div id="content">
       <div class="container">
       		...
       		<div class="row2"><h5><small>ACCOUNT E-MAIL: </small><?php echo $user['email']; ?></h5></div>
        	<div class="row">
                ...
                <?php 
					 $user_ref = $this->uri->segment(3);
                 	 echo form_open(base_url()."admin/user_edit/$user_ref", $attribute_user['form']);
      			...
      			?>
                     ...
                     <span class="form-row" ><?php echo form_input($attribute_user['submit']);?></span>
                ...
                <div class="box">
                          ...
                          <div class="box-inner">
                               ...
                               <?php
                            echo form_open(base_url()."admin/user_edit/$user_ref ",$attribute['form']);
