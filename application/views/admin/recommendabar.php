  ...
  <div class="wrapper">
    ...
    <div id="content">
       <div class="container">
            ...
            <a href="<?php echo base_url();?>admin/download_recabar" class="add-new-event" >Export to Excel</a> 
          <?php } ?>  
            <div class="events">
                   <h2 class="title2">Recommend a bar</h2> </br>
                   ...
                   <?php echo form_close();?>
                 	<?php $this->load->view('admin/recommendabar_display');?>
              </div><!-- close events -->
         </div><!-- close container -->
    </div><!-- close content -->
  </div><!--close wrapper-->
