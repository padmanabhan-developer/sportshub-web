  ...
  <div class="wrapper">
    ...
    <div id="content">
       <div class="container">
              ...
              <a href="javascript:void(0)" class="add-new-event" data-cta-target=".js-dialog1" id="popup2" title="Click here to Add" onclick="javascript:NewEstablishmentForm('<?php echo base_url();?>admin/');">new establishments</a>
              <div class="js-dialog1  modal  dialog" style="text-align: center;width:628px; min-height:369px; height:400px; margin:0;">
                 <span class="modal-close-btn"></span>
                 <div id="new_est">
                 <?php $this->load->view('admin/new-establishment');?>
           		</div>
              </div>
            ...
            <div class="events">
                   ...
                   <div class="row3">
                      ...
                      <span class="box1 small-text"><span class="checkbox-box3"><input type="radio" name="genre" class="check-1" id="check-1" value="0" /><label for="check-1"></label></span>Free Account</span>
                        <span class="box1 small-text"><span class="checkbox-box3"><input type="radio" name="genre" class="check-1" value="1" id="check-2"  /><label for="check-2"></label></span>Premium Account</span>


                   </div>     
                                <?php $this->load->view('admin/establishment_display.php');?>
              </div><!-- close events -->
         </div><!-- close container -->
    </div><!-- close content -->
...
jQuery(document).on("click", ".actdeact", function(e) {  
// $(".unblock").click(function(){  
    ...
    if(actid > 0) { 
      $.confirm({
        title: 'Please confirm!',
        content: 'Are you sure you want to downgrade account ?',
        confirm: function(){
        $.ajax
        ({ 
          url: '<?php echo base_url();?>admin/upgdwng_ajax',
          data: {id: actid, type:'unblock'},
          type: 'post',
          success: function(result) {
          //if(result){
            location.reload();
...
jQuery(document).on("click", ".viewpayment", function(e) {  
// $(".unblock").click(function(){  
    ...
    if(payid > 0) { 
        ...
        window.open("<?php echo base_url();?>admin/viewpayment?esid=" + payid + "&cusid=" + cusid,"_self")
       
     }
  });

jQuery(document).on("click", ".viewpayment11", function(e) {  
// $(".unblock").click(function(){  
