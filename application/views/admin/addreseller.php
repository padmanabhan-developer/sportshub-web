...
<div class="wrapper">
  ...
  <div id="content">
    <div class="container"> <a class="back-button" href="<?php echo base_url();?>admin/reseller">BACK TO  Reseller</a> 
      ...
      <div class="col-lg-8 col-md-6 col-sm-6 box-form">
        <div class="box">
          <h2 class="title2">Add Reseller</h2>
            <div class="box-inner">
              <!--<div class="box">-->
             <?php echo form_open(base_url()."admin/addreseller/", $attribute_reseller['form']);
