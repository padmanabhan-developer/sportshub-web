            ...
            <h2 class="title2">Add Slider</h2>
                ...
                <br>
                 <span class="form-row">
					 	...
					 	<div class="col-lg-9 col-md-6 col-sm-6"><?php echo form_input($attribute_slider['slidername']);?></div>
                     </span>
                     
                     <span class="form-row">
                     	<div class="col-lg-3 col-md-6 col-sm-6"><span class="title5">URL </span></div>
                     	<div class="col-lg-9 col-md-6 col-sm-6"><?php echo form_input($attribute_slider['url']);?></div>
                     </span>
                     
                     <span class="form-row">
                     	<div class="col-lg-3 col-md-6 col-sm-6"><span class="title5">Image </span></div>
					 	<div class="col-lg-9 col-md-6 col-sm-6"><?php echo form_upload($attribute_slider['image']); ?></div>
                     </span>
                     <?php 
                      ...
                      <span class="form-row">
					 	...
					 	<div class="col-lg-9 col-md-6 col-sm-6"><?php echo form_textarea($attribute_slider['desc']);?></div>
                     </span>
