...
<html lang="en">
  ...
  <div class="wrapper">
    ...
    <div id="content">
       <div class="container">
            <a href="<?php echo base_url();?>admin/reseller" class="back-button" >BACK TO Reseller</a> 
            <div class="row2"><h5><small>Reseller E-MAIL: </small> <?php echo $email; ?></h5></div>
            <div class="events">
                   <h2 class="title2">Establishment List</h2> </br>
                   ...
                   <div class="row3">
                 	...
                 	<?php $this->load->view('admin/reseller_est_display');?>
              </div><!-- close events -->
         </div><!-- close container -->
    </div><!-- close content -->
  </div><!--close wrapper-->
