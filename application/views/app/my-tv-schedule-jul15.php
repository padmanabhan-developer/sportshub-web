...
<script type="text/javascript" src="<?php echo base_url();?>js/app/tv_schedule.js"></script>
  ...
  <div id="content">
    <div class="container"> <a href="<?php echo base_url();?>app/schedule" class="add-new-event">Go to  tv schedule</a>
      <div class="events">
        ...
        <div class="event-form tv-event-form"> <span class="event-form-box">
        ...
        <div class="events-inner" id="show_fixture">
          <?php $this->load->view('app/display-my-tv-schedule');
      ...
      <?php if(count($fixture_list)>0) { ?>
               <div class="button_div">
                  <a href="<?php echo base_url();?>app/downloadpdf" target="_blank" class="butoon_print">Print</a>
...
<script type="text/javascript">
	...
	$('#email_send').click(function() {
		...
		$.ajax({
			url: '<?php echo base_url();?>app/emailpdf',
			type: "GET",
			data: {},
