...
<html lang="en">
  ...
  <div class="wrapper">
      ...
      <?php
      echo form_open(base_url()."app/signup",$attribute['form']);
  ...
  <h6>Already have an account?  <a href="<?php echo base_url();?>app/login">Sign in here</a></h6>

</div><!--close signup_box-->
	<?php echo form_close();?>
	   <!-- add section start-->
      	  <div class="add"><script type="text/javascript" src="http://sportshub365.com/spotway/adb.php?tag=244570660a1f2566180&width=728&height=90"></script></div>
       <!-- add section end-->	
