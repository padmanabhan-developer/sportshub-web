            	...
            	<box id="center" class="quiz" position="relative">
				  <box id="center" class="quiz_page" position="relative" anim="none" >
				  	<box id="center" class="container2" position="relative" anim="none"> 
						...
						<box id="center" class="quiz_add" position="relative" anim="none" animtime="0.5">
						<image id="add" position="relative" x="0" y="0" anim="none" class="img-responsive"><![CDATA[lib/assets/add.png]]></image>
						</box>
					</box>
